...
import { EditOutlined, LoadingOutlined, PlusOutlined, SettingOutlined } from '@ant-design/icons';
...
const AccountUser: React.FunctionComponent<IPropsAccountUser> = ({ user }) => {
    ...
    return (
        <>
            <Button icon={<SettingOutlined />} onClick={() => setIsModalOpen(true)}>Mon compte</Button>
            <Modal
                width={600}
